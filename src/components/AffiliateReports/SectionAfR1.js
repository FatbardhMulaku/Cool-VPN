...
function SectionAfR1() {
	return (
		<LayoutContainer section="SectionAfR1 bg">
			<InfoTxt 
				txt="AffiliateReports.section_1" textAlign="left" color="white" margin="0px" klasa="SectionAfR1__txt"
				DfTitle="CoolVPN Affiliate Reports" 
				DfDesc="Join now and earn money by promoting one of the 
				best VPN services."
			/>
			<Botton link="/become-partner" offsetBtn={-150} txt="AffiliateReports.section_1.btn"

        ...
        <div className="Payment__wrapper__boody">
          ...
          <div className="row">
            <div className="col-12 col-lg-6">
              <InputLogin type="text" placeholder="First name" icon="" />
            </div>
            <div className="col-12 col-lg-6">
              <InputLogin type="text" placeholder="Last name" icon="" />
            </div>
          </div>
          <div className="row">
            <div className="col-12 col-lg-6">
              <InputLogin type="number" placeholder="Card number" icon="" />
            </div>
            <div className="col-12 col-lg-6">
              <InputLogin
                type="text"
          ...
          <div className="row">
            <div className="col-12 col-lg-3">
              <InputLogin type="number" placeholder="CVV" icon="" />
            </div>
            <div className="col-12 col-lg-4">
              <InputLogin type="number" placeholder="Postal code" icon="" />
            </div>
          </div>

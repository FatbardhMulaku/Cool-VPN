...
function SectionFP3() {
	return (
		<LayoutContainer section="SectionFP3 bg">
			<InfoTxt 
				txt="FreeProxy.section_3" textAlign="center" color="white" margin="0px" klasa="SectionFP3__txt"
			...
			<div className="SectionFP3__Bbox">
				<div className="row justify-content-center SectionFP3__line">
					...
					<div className="col-3 col-lg-3"><h5><FormattedMessage
				...
				{FreeProxy.map(({ title }, idx) => (
					<div key={idx} className="row justify-content-center SectionFP3__line">
						<div className="col-6 col-lg-3"><p>{title}</p></div>

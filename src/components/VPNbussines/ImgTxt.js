...
function ImgTxt(props) {
	...
	return (
		<div className={`ImgTxt row`}>
			<div className={`${classes.box1} ${props.box1}`}></div>{/* ImgTxt__box1 */}
			<div className={`${classes.box} ${props.box}`} >  {/* ImgTxt__box */}
				<div className="ImgTxt__box__img">
					<div className={`${props.icon} bg`}/>
				</div>

				<div className={` ${classes.root} TextInfo ImgTxt__txt my-auto ${props.klasaTxt}`}>

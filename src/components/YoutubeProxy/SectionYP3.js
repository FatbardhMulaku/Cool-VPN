...
function SectionYP3() {
	return (
		<LayoutGrid section="SectionYP3">
			...
			<div className="col-sm-12 col-lg-6">
				<InfoTxt 
					txt="YoutubeProxy.section_2" textAlign="left" color="black" margin="0px" klasa="SectionYP3__txt"
			...
			<div className="col-sm-12 col-lg-6">
				<InfoTxt 
					txt="YoutubeProxy.section_2b" textAlign="left" color="black" margin="0px" klasa="SectionYP3__txt"

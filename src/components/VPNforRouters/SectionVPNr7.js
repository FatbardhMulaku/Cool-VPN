...
function SectionVPNr7() {
	return (
		<LayoutGrid section="SectionVPNr7">
			...
			<InfoTxt 
				txt="VPNforRouters.section_7" textAlign="left" color="white" margin="0px" klasa="SectionVPNr3__txt"
			...
			/>
			<div>
				<Botton link="/" offsetBtn={-150} txt="VPNforRouters.section_7.btn"
					BGcolor="#fff" color="#3F3D56" margin="20px 0 0 0"

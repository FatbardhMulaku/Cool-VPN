	...
	return (
		<LayoutGrid section="SectionArt3">
			<div className="col-sm-12 col-lg-7">
				<InfoTxt 
					txt="Articles.section_3a" textAlign="left" color="black" margin="10px 0 0 0" klasa="SectionArt3__txt"
			...
			<div className="col-sm-12 col-lg-7">
				<InfoTxt 
					txt="Articles.section_3b" textAlign="left" color="black" margin="10px 0 0 0" klasa="SectionArt3__txt"
			...
			<div className="col-sm-12 col-lg-7">
				<InfoTxt 
					txt="Articles.section_3c" textAlign="left" color="black" margin="10px 0 0 0" klasa="SectionArt3__txt"

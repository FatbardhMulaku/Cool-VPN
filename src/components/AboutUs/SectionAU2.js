	...
	return (
		<LayoutGrid section="SectionAU2">
			...
			<div className="col-sm-12 col-lg-9 SectionAU2__box1">
				<InfoTxt 
					txt="AboutUs.section_2" textAlign="left" color="black" margin="0px" klasa="SectionPA2__txt"
					DfTitle="Who we are" 
			...
			<div className="col-sm-12 col-lg-9 SectionAU2__box3">
				<InfoTxt 
					txt="AboutUs.section_2b" textAlign="left" color="black" margin="0px" klasa="SectionPA2__txt"

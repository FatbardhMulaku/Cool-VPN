	...
	return (
		<LayoutGrid section="SectionAIP2">
			...
			<div className="col-sm-12 col-lg-9 SectionAIP2__box1">
				<InfoTxt 
					txt="AnonymousIP.section_2" textAlign="left" color="black" margin="0px" klasa="SectionPA2__txt"
			...
			<div className="SectionAIP2__img3 bg"><div className="bg"/></div>
			<div className="col-lg-3"/>
			<div className="col-sm-12 col-lg-9 SectionAIP2__box3">
				<InfoTxt 
					txt="AnonymousIP.section_2c" textAlign="left" color="black" margin="0px" klasa="SectionPA2__txt"

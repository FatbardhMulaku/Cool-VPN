	...
	return (
		<LayoutGrid section="SectionFAQ2">
			<div className="col-sm-12 col-lg-3 SectionFAQ2__btnBox">
				<Botton link="/faq/#" offsetBtn={-150} txt="FAQ.section_2.btn1"
					...
					DfBtn="General"
				/>
				<Botton link="/faq/#" offsetBtn={-150} txt="FAQ.section_2.btn2"
					...
					DfBtn="Transactions"
				/>
				<Botton link="/faq/#" offsetBtn={-150} txt="FAQ.section_2.btn3"
					BGcolor="#fff" color="#000" margin="10px"
					HoverBGcolor="#D57FAD" HoverColor="#fff"
					border="1px solid #fff"
					HoverBorder="1px solid #D57FAD"
					DfBtn="Services"
				/>
				<Botton link="/faq/#" offsetBtn={-150} txt="FAQ.section_2.btn4"
					BGcolor="#fff" color="#000" margin="10px"
					HoverBGcolor="#D57FAD" HoverColor="#fff"
					border="1px solid #fff"
					HoverBorder="1px solid #D57FAD"

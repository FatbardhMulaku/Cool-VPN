  ...
  return (
    <LayoutContainer section="SectionAS5">
      <div className="SectionAS5__box mx-auto">
        ...
        <InputLogin type="text" placeholder="Full Name" icon="" />
        <InputLogin type="email" placeholder="Work Email" icon="" />
        <InputLogin type="text" placeholder="Company Name" icon="" />
        <div className="row">
          <div className="col-12 col-sm-6">
            <InputLogin type="text" placeholder="Company URL" icon="" />
          </div>
          <div className="col-12 col-sm-6">
            <InputLogin type="email" placeholder="Country" icon="" />
          </div>
        </div>
        <InputLogin type="number" placeholder="Phone" icon="" />
        ...
        <div>
          <Botton
            link="/become-partner"
            offsetBtn={-150}
            txt="AffiliateSales.section_5.btn"
            BGcolor="#8878BF"
            color="#fff"
            margin="10px"
            HoverBGcolor="#fff"

...
function SectionAS4() {
	return (
		<LayoutGrid section="SectionAS4">
			...
			<InfoTxt 
				txt="AffiliateSales.section_4" textAlign="left" color="black" margin="0px" klasa="SectionAS4__txt"
			...
			/>
			<div>
			<Botton link="/become-partner" offsetBtn={-150} txt="AffiliateSales.section_4.btn"
